...
public class Item
{
    ...
    /// </summary>
    [JsonIgnore]
    public DateTime? CreatedAt => !string.IsNullOrWhiteSpace(CreatedAtString) ? (DateTime?)DateTimeOffset.Parse((CreatedAtString ?? String.Empty).Replace("UTC", string.Empty)).LocalDateTime : null;
    ...
    /// </summary>
    [JsonIgnore]
    public DateTime? UpdatedAt => !string.IsNullOrWhiteSpace(UpdatedAtString) ? (DateTime?)DateTimeOffset.Parse((UpdatedAtString ?? String.Empty).Replace("UTC", string.Empty)).LocalDateTime : null;
}